...
var T=require('@stdlib/assert-is-wasm-memory/dist'),f=require('@stdlib/utils-define-nonenumerable-read-only-property/dist'),B=require('@stdlib/utils-inherit/dist'),h=require('@stdlib/wasm-module-wrapper/dist'),V=require('@stdlib/error-tools-fmtprodmsg/dist'),g=q();function n(e){if(!(this instanceof n))return new n(e);if(!T(e))throw new TypeError(V('26PH0',e));return h.call(this,g,e,{env:{memory:e}}),this}B(n,h);f(n.prototype,"main",function(r,s,i,t){return this._instance.exports.c_cscal(r,s,i,t),i});f(n.prototype,"ndarray",function(r,s,i,t,o){return this._instance.exports.c_cscal_ndarray(r,s,i,t,o),i});m.exports=n
