...
function Module( memory ) {
	...
	if ( !isWebAssemblyMemory( memory ) ) {
		throw new TypeError( format( '26PH0', memory ) );
	}
...
* // => <Float32Array>[ -2.0, 6.0, -2.0, 14.0, -2.0, 22.0, -2.0, 30.0, -2.0, 38.0 ]
*/
setReadOnly( Module.prototype, 'main', function cscal( N, aptr, xptr, strideX ) {
...
* // => <Float32Array>[ -2.0, 6.0, -2.0, 14.0, -2.0, 22.0, -2.0, 30.0, -2.0, 38.0 ]
*/
setReadOnly( Module.prototype, 'ndarray', function cscal( N, aptr, xptr, strideX, offsetX ) {
